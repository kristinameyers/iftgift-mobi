...
<head>
	...
	?>
<meta name="google-site-verification" content="U4fGYoEBa2VUnkfIzFEy-Z2cwUFNtsEe4ETjI4gqpzM" />
</head>
<body>
<div data-role="page">
	<div role="main" class="ui-content ui-content-b">
		...
		<a href="<?php echo ru?>cart/" data-ajax="false" class="ui-btn ui-corner-all ui-shadow ui-btn-inline iftgift item"><div class="ift_gift"><img src="<?php echo ru_resource?>images/item_icon.png" /><div class="ift_value"><?php echo count($_SESSION["products"]); ?></div></div></a>
		...
		<div id="list">
			...
			<a href="<?php echo ru;?>dashboard" data-ajax="false" class="ui-btn ui-corner-all ui-shadow ui-btn-inline dashboard <?php if($page == 'dashboard') {?>selected<?php } ?>"><span>Dashboard</span></a>
			<a href="<?php echo ru;?>cash_stash" data-ajax="false" class="ui-btn ui-corner-all ui-shadow ui-btn-inline cash <?php if($page == 'cash_stash') {?>selected<?php } ?>"><span>Cash^Stash</span></a>
			<a href="<?php echo ru;?>logout" data-ajax="false" class="ui-btn ui-corner-all ui-shadow ui-btn-inline logout"> <span>Logout</span></a>
		</div>
