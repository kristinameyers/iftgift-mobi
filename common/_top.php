...
<?php } ?>
	...
	<?php if($page == 'delivery_detail' || $page == 'giver_info' || $page == 'recp_info' || $page == 'notify_datetime' || $page == 'unlock_datetime' || $page == 'personal_note' || $page == 'checkout' || $page == 'confirmation' || $page == 'cart' || $page == 'review_gift') {} else if($page == 'open_iftgift' || $page == 'locked' || $page == 'unwraped') {
	$delivery_id = $_GET['s'];
	...
	<?php } ?>
	<?php if($page == 'cart' || $page == 'detail' || $page == 'delivery_detail' || $page == 'giver_info' || $page == 'recp_info' || $page == 'notify_datetime' || $page == 'unlock_datetime' || $page == 'review_gift' || $page == 'personal_note' || $page == 'checkout' || $page == 'confirmation' || $page == 'locked' || $page == 'open_iftgift' || $page == 'unwraped' || $page == 'search') { } else {?>
	<script type="text/javascript">
	$(document).ready(function () {
		$('#only').click(function () {
