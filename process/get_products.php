...
?>	
  	<div role="main" class="ui-content jqm-content jqm-content-c">
		...
		<h3>More info <img src="<?php echo ru_resource;?>images/info_arrow.jpg" style="cursor:pointer" alt="More Info Arrow" id="more_info3" /></h3>
...
$(document).ready(function () {
	$("#more_info3").click(function () {
		var test = $("#prod_desp").slideToggle('slow', function () {
			if ($("#prod_desp").css('display') === 'none')
		{
			$("#more_info3").attr("src", "<?php echo ru_resource ?>images/info_arrow.jpg");
		} else {
			$("#more_info3").attr("src", "<?php echo ru_resource ?>images/info_arrow_btm.jpg");
		}
		});
	})
})
